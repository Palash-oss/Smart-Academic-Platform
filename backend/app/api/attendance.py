...
from app.schemas.attendance import MarkAttendanceRequest, RosterStudentRow
...
async def get_faculty_attendance_overview(
    ...
    """Faculty Dashboard endpoint: Returns attendance breakdown and risk status for all enrolled students."""
    return await fetch_all_students_faculty_overview(db)
...
async def mark_attendance_endpoint(
    ...
    """Feature 2: Live Attendance Marking endpoint for Faculty.
...
async def import_roster_endpoint(
    ...
    """Feature 1: Bulk Roster Import endpoint accepting CSV upload (name,email)."""
